...
// Action, ActionContext, Validation) is owned by @headless-lms/integration-sdk
// so integration packages and the platform share one definition; the context
// re-exports it as part of its public surface.
import type { Integration } from "@headless-lms/integration-sdk";
import type { ConfigureInput, ConnectInput, Connection } from "./model.js";

export type { Validation, ActionContext, Action, Integration } from "@headless-lms/integration-sdk";
