...
import { useEnrollments, useSetEnrollmentStatus } from "@/lib/api/hooks";
...
const SOURCE_LABEL: Record<Enrollment["source"], string> = {
  manual: "Manual",
  purchase: "Purchase",
  import: "Import",
};

/** True when an active enrollment lapses within days (warning tone). */
function isExpiringSoon(expiresAt: string | null, status: Enrollment["status"]): boolean {
...
export default function EnrollmentsPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        title="Enrollments"
        description="Every grant of course access across your organization — manual, purchased, or imported."
      />
