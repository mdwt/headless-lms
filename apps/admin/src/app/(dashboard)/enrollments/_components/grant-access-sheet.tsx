...
import { useCoursesLite, useGrantEnrollment, useStudentsLite } from "@/lib/api/hooks";
...
export function GrantAccessSheet({
  ...
  return (
    <FormSheet
      ...
      title="Grant access"
      description="Enroll a student into a course manually. They'll get immediate access."
      formId={FORM_ID}
        ...
        <Controller
          ...
          render={({ field }) => (
            <Field
              id="expiryMode"
              label="Access expiry"
              hint="Lifetime access never expires; set a date to time-box this enrollment."
            >
              <Select value={field.value} onValueChange={field.onChange}>
